(function() {
    'use strict';
    var f, aa = typeof Object.create == "function" ? Object.create : function(a) {
            var b = function() {};
            b.prototype = a;
            return new b
        },
        g;
    if (typeof Object.setPrototypeOf == "function") g = Object.setPrototypeOf;
    else {
        var k;
        a: {
            var ba = {
    ...
    */
    var q = this || self,
        ...
        v = function(a, b, c) {
            v = Function.prototype.bind && Function.prototype.bind.toString().indexOf("native code") != -1 ? ia : ja;
            return v.apply(null, arguments)
        },
        w = function(a, b) {
            a = a.split(".");
            for (var c = q, d; a.length && (d = a.shift());) a.length || b === void 0 ? c[d] && c[d] !== Object.prototype[d] ? c = c[d] : c = c[d] = {} : c[d] = b
        };
    ...
    chrome.cast.rc = !0;
    w("chrome.cast.usingPresentationApi", chrome.cast.rc);
    chrome.cast.Na = function(a, b) {
        this.credentials = a;
        this.credentialsType = b === void 0 ? "web" : b
    };
    w("chrome.cast.CredentialsData", chrome.cast.Na);
    ...
    w("chrome.cast.SenderApplication", chrome.cast.nb);
    ...
    w("chrome.cast.AutoJoinPolicy", chrome.cast.ha);
    chrome.cast.ja = {
        CREATE_SESSION: "create_session",
        CAST_THIS_TAB: "cast_this_tab"
    };
    w("chrome.cast.DefaultActionPolicy", chrome.cast.ja);
    chrome.cast.Ma = {
        VIDEO_OUT: "video_out",
        AUDIO_OUT: "audio_out",
        VIDEO_IN: "video_in",
    ...
    w("chrome.cast.Capability", chrome.cast.Ma);
    chrome.cast.A = {
        CANCEL: "cancel",
        TIMEOUT: "timeout",
    ...
    w("chrome.cast.ErrorCode", chrome.cast.A);
    chrome.cast.N = {
        AVAILABLE: "available",
        UNAVAILABLE: "unavailable"
    };
    w("chrome.cast.ReceiverAvailability", chrome.cast.N);
    chrome.cast.ob = {
        CHROME: "chrome",
        IOS: "ios",
        ANDROID: "android"
    };
    w("chrome.cast.SenderPlatform", chrome.cast.ob);
    chrome.cast.xa = {
        CAST: "cast",
        DIAL: "dial",
        HANGOUT: "hangout",
    ...
    w("chrome.cast.ReceiverType", chrome.cast.xa);
    chrome.cast.Qa = {
        RUNNING: "running",
        STOPPED: "stopped",
        ERROR: "error"
    };
    w("chrome.cast.DialAppState", chrome.cast.Qa);
    chrome.cast.jb = {
        CAST: "cast",
        STOP: "stop"
    };
    w("chrome.cast.ReceiverAction", chrome.cast.jb);
    chrome.cast.K = {
        CONNECTED: "connected",
        DISCONNECTED: "disconnected",
        STOPPED: "stopped"
    };
    w("chrome.cast.SessionStatus", chrome.cast.K);
    chrome.cast.Db = {
        ATTENUATION: "attenuation",
        FIXED: "fixed",
        MASTER: "master"
    };
    w("chrome.cast.VolumeControlType", chrome.cast.Db);
    var ka = /&/g,
        la = /</g,
        ma = />/g,
        na = /"/g,
    ...
    */
    ...
    function sa() {
        if (ra !== ra) throw Error("Bad secret");
    };
    var ta = globalThis.trustedTypes,
        x;
    ...
    var za = Object.freeze || function(a) {
        return a
    };
    var Ba = function(a) {
            var b = {
            ...
            return a.replace(Aa, function(d, e) {
                var h = b[d];
                if (h) return h;
    ...
    w("chrome.cast.ApiConfig", chrome.cast.Ia);
    chrome.cast.Ta = function(a, b) {
        this.appName = a;
        this.launchParameter = b || null
    };
    w("chrome.cast.DialRequest", chrome.cast.Ta);
    chrome.cast.Ra = function(a, b, c) {
        this.receiver = a;
        this.appState = b;
        this.extraData = c || null
    };
    w("chrome.cast.DialLaunchData", chrome.cast.Ra);
    chrome.cast.Sa = function(a, b) {
        this.doLaunch = a;
        this.launchParameter = b || null
    };
    w("chrome.cast.DialLaunchResponse", chrome.cast.Sa);
    ...
    w("chrome.cast.SessionRequest", chrome.cast.pb);
    ...
    w("chrome.cast.Receiver", chrome.cast.ib);
    chrome.cast.kb = function(a, b) {
        this.statusText = a;
        this.appImages = b;
        this.showStop = null
    };
    w("chrome.cast.ReceiverDisplayStatus", chrome.cast.kb);
    ...
    w("chrome.cast.Timeout", chrome.cast.Aa);
    ...
    w("chrome.cast.media.HdrType", chrome.cast.media.Va);
    ...
    w("chrome.cast.media.HlsSegmentFormat", chrome.cast.media.Wa);
    chrome.cast.media.Xa = {
        MPEG2_TS: "mpeg2_ts",
        FMP4: "fmp4"
    };
    w("chrome.cast.media.HlsVideoSegmentFormat", chrome.cast.media.Xa);
    ...
    w("chrome.cast.media.MediaCommand", chrome.cast.media.ab);
    ...
    w("chrome.cast.media.QueueType", chrome.cast.media.gb);
    chrome.cast.media.U = {
        GENERIC_CONTAINER: 0,
        AUDIOBOOK_CONTAINER: 1
    };
    w("chrome.cast.media.ContainerType", chrome.cast.media.U);
    chrome.cast.media.F = {
        GENERIC: 0,
        MOVIE: 1,
        TV_SHOW: 2,
    ...
    w("chrome.cast.media.MetadataType", chrome.cast.media.F);
    chrome.cast.media.B = {
        IDLE: "IDLE",
        PLAYING: "PLAYING",
        PAUSED: "PAUSED",
    ...
    w("chrome.cast.media.PlayerState", chrome.cast.media.B);
    chrome.cast.media.V = {
        OFF: "REPEAT_OFF",
        ALL: "REPEAT_ALL",
    ...
    w("chrome.cast.media.RepeatMode", chrome.cast.media.V);
    chrome.cast.media.lb = {
        PLAYBACK_START: "PLAYBACK_START",
        PLAYBACK_PAUSE: "PLAYBACK_PAUSE"
    };
    w("chrome.cast.media.ResumeState", chrome.cast.media.lb);
    chrome.cast.media.za = {
        BUFFERED: "BUFFERED",
        LIVE: "LIVE",
        OTHER: "OTHER"
    };
    w("chrome.cast.media.StreamType", chrome.cast.media.za);
    ...
    w("chrome.cast.media.IdleReason", chrome.cast.media.Ya);
    chrome.cast.media.yb = {
        TEXT: "TEXT",
        AUDIO: "AUDIO",
        VIDEO: "VIDEO"
    };
    w("chrome.cast.media.TrackType", chrome.cast.media.yb);
    ...
    w("chrome.cast.media.TextTrackType", chrome.cast.media.ub);
    ...
    w("chrome.cast.media.TextTrackEdgeType", chrome.cast.media.qb);
    chrome.cast.media.wb = {
        NONE: "NONE",
        NORMAL: "NORMAL",
        ROUNDED_CORNERS: "ROUNDED_CORNERS"
    };
    w("chrome.cast.media.TextTrackWindowType", chrome.cast.media.wb);
    ...
    w("chrome.cast.media.TextTrackFontGenericFamily", chrome.cast.media.rb);
    ...
    w("chrome.cast.media.TextTrackFontStyle", chrome.cast.media.sb);
    ...
    w("chrome.cast.media.UserAction", chrome.cast.media.zb);
    chrome.cast.media.la = function() {
        this.customData = null
    };
    w("chrome.cast.media.GetStatusRequest", chrome.cast.media.la);
    chrome.cast.media.pa = function() {
        this.customData = null
    };
    w("chrome.cast.media.PauseRequest", chrome.cast.media.pa);
    chrome.cast.media.ra = function() {
        this.customData = null
    };
    w("chrome.cast.media.PlayRequest", chrome.cast.media.ra);
    chrome.cast.media.mb = function() {
        this.customData = this.resumeState = this.currentTime = null
    };
    w("chrome.cast.media.SeekRequest", chrome.cast.media.mb);
    chrome.cast.media.ya = function() {
        this.customData = null
    };
    w("chrome.cast.media.StopRequest", chrome.cast.media.ya);
    chrome.cast.media.Eb = function(a) {
        this.volume = a;
        this.customData = null
    };
    w("chrome.cast.media.VolumeRequest", chrome.cast.media.Eb);
    ...
    w("chrome.cast.media.LoadRequest", chrome.cast.media.Za);
    chrome.cast.media.Ua = function(a, b) {
        this.requestId = 0;
        this.activeTrackIds = a || null;
        this.textTrackStyle = b || null
    };
    w("chrome.cast.media.EditTracksInfoRequest", chrome.cast.media.Ua);
    ...
    w("chrome.cast.media.ContainerMetadata", chrome.cast.media.T);
    ...
    w("chrome.cast.media.MediaMetadata", chrome.cast.media.MediaMetadata);
    ...
    n(chrome.cast.media.ka, chrome.cast.media.MediaMetadata);
    w("chrome.cast.media.GenericMediaMetadata", chrome.cast.media.ka);
    ...
    n(chrome.cast.media.na, chrome.cast.media.MediaMetadata);
    w("chrome.cast.media.MovieMediaMetadata", chrome.cast.media.na);
    ...
    n(chrome.cast.media.Ba, chrome.cast.media.MediaMetadata);
    w("chrome.cast.media.TvShowMediaMetadata", chrome.cast.media.Ba);
    ...
    n(chrome.cast.media.oa, chrome.cast.media.MediaMetadata);
    w("chrome.cast.media.MusicTrackMediaMetadata", chrome.cast.media.oa);
    ...
    n(chrome.cast.media.qa, chrome.cast.media.MediaMetadata);
    w("chrome.cast.media.PhotoMediaMetadata", chrome.cast.media.qa);
    ...
    n(chrome.cast.media.ga, chrome.cast.media.T);
    w("chrome.cast.media.AudiobookContainerMetadata", chrome.cast.media.ga);
    ...
    n(chrome.cast.media.fa, chrome.cast.media.MediaMetadata);
    w("chrome.cast.media.AudiobookChapterMediaMetadata", chrome.cast.media.fa);
    ...
    w("chrome.cast.media.MediaInfo", chrome.cast.media.bb);
    ...
    w("chrome.cast.media.QueueItem", chrome.cast.media.ta);
    chrome.cast.media.Pa = "CC1AD845";
    w("chrome.cast.media.DEFAULT_MEDIA_RECEIVER_APP_ID", chrome.cast.media.Pa);
    ...
    w("chrome.cast.media.timeout.getStatus", chrome.cast.media.timeout.P);
    ...
    w("chrome.cast.media.timeout.setVolume", chrome.cast.media.timeout.R);
    chrome.cast.media.timeout.O = 0;
    w("chrome.cast.media.timeout.editTracksInfo", chrome.cast.media.timeout.O);
    chrome.cast.media.timeout.v = 0;
    w("chrome.cast.media.timeout.queue", chrome.cast.media.timeout.v);
    ...
    w("chrome.cast.media.Track", chrome.cast.media.xb);
    ...
    w("chrome.cast.media.TextTrackStyle", chrome.cast.media.tb);
    ...
    w("chrome.cast.media.QueueLoadRequest", chrome.cast.media.fb);
    ...
    w("chrome.cast.media.QueueInsertItemsRequest", chrome.cast.media.sa);
    ...
    w("chrome.cast.media.QueueUpdateItemsRequest", chrome.cast.media.hb);
    ...
    w("chrome.cast.media.QueueSetPropertiesRequest", chrome.cast.media.wa);
    ...
    w("chrome.cast.media.QueueRemoveItemsRequest", chrome.cast.media.ua);
    ...
    w("chrome.cast.media.QueueReorderItemsRequest", chrome.cast.media.va);
    ...
    w("chrome.cast.media.Break", chrome.cast.media.Ja);
    ...
    w("chrome.cast.media.LiveSeekableRange", chrome.cast.media.ma);
    chrome.cast.media.eb = function(a, b, c, d, e, h, l) {
        this.id = a;
    ...
    w("chrome.cast.media.QueueData", chrome.cast.media.eb);
    chrome.cast.media.Ab = function(a) {
        this.userAction = a;
        this.customData = void 0
    };
    w("chrome.cast.media.UserActionState", chrome.cast.media.Ab);
    chrome.cast.media.Cb = function(a, b, c) {
        this.width = a;
        this.height = b;
        this.hdrType = c
    };
    w("chrome.cast.media.VideoInformation", chrome.cast.media.Cb);
    var A = null;
    ...
    f.P = function(a, b, c) {
        ...
        A.m(this, "MEDIA_GET_STATUS", a, b, c, chrome.cast.media.timeout.P)
    };
    ...
    f.seek = function(a, b, c) {
        A.m(this, "SEEK", a, b, c, chrome.cast.media.timeout.seek)
    };
    f.stop = function(a, b, c) {
        a || (a = new chrome.cast.media.ya);
        A.m(this, "STOP_MEDIA", a, b, c, chrome.cast.media.timeout.stop)
    };
    f.R = function(a, b, c) {
        A.m(this, "MEDIA_SET_VOLUME", a, b, c, chrome.cast.media.timeout.R)
    };
    f.O = function(a, b, c) {
        A.m(this, "EDIT_TRACKS_INFO", a, b, c, chrome.cast.media.timeout.O)
    };
    f.Tb = function(a, b, c) {
        A.m(this, "QUEUE_INSERT", a, b, c, chrome.cast.media.timeout.v)
    };
    f.Sb = function(a, b, c) {
        A.m(this, "QUEUE_INSERT", new chrome.cast.media.sa([a]), b, c, chrome.cast.media.timeout.v)
    };
    f.dc = function(a, b, c) {
        A.m(this, "QUEUE_UPDATE", a, b, c, chrome.cast.media.timeout.v)
    };
    f.Yb = function(a, b) {
        var c = new chrome.cast.media.M;
        c.jump = -1;
        A.m(this, "QUEUE_UPDATE", c, a, b, chrome.cast.media.timeout.v)
    };
    f.Xb = function(a, b) {
        var c = new chrome.cast.media.M;
        c.jump = 1;
    ...
    f.Ub = function(a, b, c) {
        if (!(B(this, a) < 0)) {
            ...
            d.currentItemId = a;
            A.m(this, "QUEUE_UPDATE", d, b, c, chrome.cast.media.timeout.v)
        }
    };
    f.cc = function(a, b, c) {
    ...
    f.ac = function(a, b, c) {
        A.m(this, "QUEUE_REMOVE", a, b, c, chrome.cast.media.timeout.v)
    };
    f.Zb = function(a, b, c) {
        B(this, a) < 0 || A.m(this, "QUEUE_REMOVE", new chrome.cast.media.ua([a]), b, c, chrome.cast.media.timeout.v)
    };
    f.bc = function(a, b, c) {
        A.m(this, "QUEUE_REORDER", a, b, c, chrome.cast.media.timeout.v)
    };
    f.Wb = function(a, b, c, d) {
        ...
        if (!(e < 0))
            ...
            A.m(this, "QUEUE_REORDER", a, c, d, chrome.cast.media.timeout.v)
        }
    };
    f.qc = function(a) {
    ...
    f.oc = function(a, b, c) {
        var d = A;
        a = new Ea(new chrome.cast.Volume(a, null), this.receiver.volume);
        d.setReceiverVolume(this.sessionId, a, b, c)
    };
    f.nc = function(a, b, c) {
        a = new Ea(new chrome.cast.Volume(null, a), this.receiver.volume);
        A.setReceiverVolume(this.sessionId, a, b, c)
    };
    f.getDialAppInfo = function(a, b) {
        A.getDialAppInfo(a, b)
    };
    f.Ob = function(a, b) {
        A.leaveSession(this.sessionId, a, b)
    };
    f.stop = function(a, b) {
        A.Da(new Fa(this.sessionId), a, b, chrome.cast.timeout.stopSession)
    };
    f.sendMessage = function(a, b, c, d) {
        A.kc(new Da(this.sessionId, a, b), c, d)
    };
    f.Y = function(a) {
        A.Ib(this.sessionId, a)
    };
    f.ba = function(a) {
        A.jc(this.sessionId, a)
    };
    f.Hb = function(a, b) {
        A.Fb(this.sessionId, a, b)
    };
    f.W = function(a) {
        A.W(this.sessionId, a)
    };
    f.Z = function(a) {
        A.Z(this.sessionId, a)
    };
    f.hc = function(a, b) {
        A.ec(this.sessionId, a, b)
    };
    f.Pb = function(a, b, c) {
    ...
    f.Vb = function(a, b, c) {
        a.sessionId = this.sessionId;
        A.Ea(a, "QUEUE_LOAD", b, c)
    };
    w("chrome.cast.Session", chrome.cast.j);
    ...
    var Ia = function(a) {
            ...
            if (typeof a.next == "function") return new G(function() {
                return a
            });
            if (typeof a[Symbol.iterator] == "function") return new G(function() {
                return a[Symbol.iterator]()
            });
            if (typeof a.o == "function") return new G(function() {
                return a.o()
            });
    ...
    function J(a, b) {
        ...
        if (c > 1) {
            ...
            if (a instanceof J)
                for (c = Ja(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
    ...
    J.prototype.delete = function(a) {
        return L(this.i, a) ? (delete this.i[a], --this.size, this.l++, this.g.length > 2 * this.size && K(this), !0) : !1
    };
    var K = function(a) {
    ...
    f.forEach = function(a, b) {
        for (var c = Ja(this), d = 0; d < c.length; d++) {
            var e = c[d],
                h = this.get(e);
            a.call(b, h, e, this)
        }
    ...
    f.keys = function() {
        return Ia(this.o(!0)).i()
    };
    f.values = function() {
        return Ia(this.o(!1)).i()
    };
    f.entries = function() {
        var a = this;
        return Ga(this.keys(), function(b) {
            return [b, a.get(b)]
        })
    };
    f.o = function(a) {
    ...
    P.prototype.connect = function(a) {
        this.g = a;
        this.g.onmessage = v(this.u, this);
        Na(this, new O("client_connect", this.i))
    };
    ...
    var Qa = function(a, b, c, d, e, h, l, m, p, t) {
            this.I = a;
            this.g = b || null;
            this.l = c || null;
            this.C = d || null;
        ...
        Ra = function(a) {
            var b = a.I.map(function(c) {
                ...
                c.call(e, "appParams", l.call(h, m));
                return d + "?" + e.toString()
            });
            a.i && b.push(Pa(new Oa(a.i, a.H, a.g)));
            return b
        };
    var Sa = function() {
            this.g = {};
        ...
        Ua = function(a, b) {
            ...
            if (a.playerState == chrome.cast.media.B.IDLE && a.loadingItemId == null) a.currentItemId = null, a.loadingItemId = null, a.preloadedItemId = null, a.items = null;
                ...
                c = {};
                if (h)
                    for (var l = 0; l < h.length; l++) c[h[l].itemId] = l;
                b = fa(b.items);
                for (h = b.next(); !h.done; h = b.next()) {
                    h = h.value;
                    if (!h.media) {
                        l = h.itemId;
                        var m = a.items ? a.items[c[l]] : null;
                        m && m.media ? h.media = m.media : l == a.currentItemId &&
    ...
    var Xa = Q().toLowerCase().indexOf("webkit") != -1 && Q().indexOf("Edge") == -1;
    var Ya = {},
        R = null,
        Za = Q().indexOf("Gecko") != -1 && !(Q().toLowerCase().indexOf("webkit") != -1 && Q().indexOf("Edge") == -1) && !(Q().indexOf("Trident") != -1 || Q().indexOf("MSIE") != -1) && Q().indexOf("Edge") == -1 || Xa || typeof q.btoa == "function";

    function $a(a) {
        if (Za) var b = q.btoa(a);
        else {
            b = [];
            ...
            a === void 0 && (a = 0);
            if (!R)
                for (R = {}, c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""), d = ["+/=", "+/", "-_=", "-_.", "-_"], e = 0; e < 5; e++) {
            ...
            switch (b.length - h) {
                case 2:
                    l = b[h + 1], m = a[(l & 15) << 2] || d;
                case 1:
                    b = b[h], c[e] = "" + a[b >> 2] + a[(b & 3) << 4 | l >> 4] + m + d
            }
            b = c.join("")
        }
        return b
    ...
    var T = function(a) {
        var b = typeof a;
        return b == "object" && a || b == "function" ? "o" + (Object.prototype.hasOwnProperty.call(a, u) && a[u] || (a[u] = ++ha)) : b.slice(0, 1) + a
    };
    f = S.prototype;
    f.add = function(a) {
        this.g.set(T(a), a);
    ...
    var U = function() {
        ...
        V = function(a, b, c, d) {
            ...
            d = Na(a.C, b);
            c && d && (a = Ma(a.S, b.sequenceNumber)) && (a = a.g, d = new chrome.cast.Error(chrome.cast.A.INVALID_PARAMETER,
                d), a && a(d))
        };
    U.prototype.initialize = function(a, b) {
        var c = this;
        A = this;
        this.g = a;
        a.invisibleSender || (a = new PresentationRequest(W(this)), a.getAvailability().then(function(d) {
            d.onchange = function() {
            ...
            X(c, d.connection)
        }, this.ia = (q.navigator || null).presentation.defaultRequest = a, a.reconnect(chrome.cast.Ha).then(function(d) {
            X(c, d)
        }, function() {}));
        b && b(void 0)
    };
    ...
    var X = function(a, b, c) {
        ...
        b.onclose = function(d) {
            ...
            switch (d.reason) {
                case "closed":
                    cb(a, chrome.cast.K.DISCONNECTED);
                    break;
                case "error":
                    if (c) {
                        d = c;
        ...
        b.onterminate = function() {
            cb(a, chrome.cast.K.STOPPED)
        };
        b.state == "connected" ? a.C.connect(b) : b.onconnect = function() {
            a.C.connect(b)
        }
    };
    U.prototype.requestSession = function(a, b, c) {
        var d = this;
        this.l ? bb(b) : (c = W(this, c), this.l = a, (new PresentationRequest(c)).start().then(function(e) {
            X(d, e, b)
        }).catch(function(e) {
            d.l = null;
    ...
    var W = function(a, b) {
        ...
        var e = b.dialRequest;
        e && (c = e.appName, (d = e.launchParameter) && !d.match(db) && (d = $a(d)));
        var h = [];
        h.push({
            appId: b.appId,
            capabilities: b.capabilities
        });
        b || xa(a.g.additionalSessionRequests, function(l) {
            h.push({
                appId: l.appId,
                capabilities: l.capabilities
            })
        });
        return Ra(new Qa(h, a.C.i, a.g.autoJoinPolicy, a.g.defaultActionPolicy, b.requestSessionTimeout, c, d, a.g.invisibleSender, b.androidReceiverCompatible, b.credentialsData))
    };
    U.prototype.Ea = function(a, b, c, d) {
        eb(this, null, b, a, function(e) {
            e.l = !0;
            c && c(e)
        }, function(e) {
            d(e)
    ...
    U.prototype.m = function(a, b, c, d, e, h) {
        var l = this;
        eb(this, a, b, c, function(m) {
            l.Ca(m);
            d && d(void 0)
        }, e, h)
    };
    var eb = function(a, b, c, d, e, h, l) {
        d.type = c;
    ...
    f.setReceiverVolume = function(a, b, c, d) {
        b.sessionId = a;
        V(this, new O("v2_message", b, void 0, chrome.cast.timeout.setReceiverVolume), new N(this.i, c, d, chrome.cast.timeout.sendCustomMessage))
    };
    f.getDialAppInfo = function(a, b) {
        V(this, new O("dial_app_info", void 0, void 0, chrome.cast.timeout.getDialAppInfo), new N(this.i, a, b, chrome.cast.timeout.sendCustomMessage))
    };
    f.ca = function(a) {
        var b = this;
        (new PresentationRequest(W(this))).reconnect(chrome.cast.cb + a).then(function(c) {
            X(b, c)
        }, function() {})
    };
    f.leaveSession = function(a, b, c) {
        V(this, new O("leave_session", a, void 0, chrome.cast.timeout.leaveSession), new N(this.i, b, c, chrome.cast.timeout.leaveSession))
    };
    f.kc = function(a, b, c) {
        V(this, new O("app_message", a, void 0, chrome.cast.timeout.sendCustomMessage), new N(this.i, b, c, chrome.cast.timeout.sendCustomMessage))
    };
    f.Da = function(a, b, c, d) {
        V(this, new O("v2_message", a, void 0, d), new N(this.i, b, c, d))
    };
    ...
    var cb = function(a, b) {
        if (a.H) {
            ...
            Ta(a.G, c, b) && (a.u.delete(c), a.I.delete(c), b = a.D.get(c)) && (a.D.delete(c), F(b.o(), function(e) {
                e(d)
            }))
        }
    };
    U.prototype.onMessage = function(a) {
        switch (a.type) {
            case "new_session":
            case "update_session":
                a.message = Va(this.G, a.message);
                break;
            case "v2_message":
                var b = a.message;
                b && b.type == "MEDIA_STATUS" && b.status && (b.status = b.status.map(this.Oa))
        }
        if (b = Ma(this.S, a.sequenceNumber)) a.type == "error" ? (b = b.g) && b(a.message) : (b = b.l) && b(a.message);
        if (b = a.message) switch (a.type) {
            ...
            case "custom_dial_launch":
                jb(this, a.sequenceNumber, b)
        }
    };
    var hb = function(a, b) {
            (a = a.D.get(b.sessionId)) && F(a.o(), function(c) {
                c(!0)
            })
        },
        gb = function(a, b) {
        ...
        ib = function(a, b) {
            (a = a.u.get(b.sessionId)) && (a = a.get(b.namespaceName)) && F(a.o(), function(c) {
                c(b.namespaceName, b.message)
            })
        },
        Y = function(a, b, c) {
            V(a, new O("custom_dial_launch", c, void 0, chrome.cast.timeout.sendCustomMessage), null, b)
        },
        jb = function(a, b, c) {
        ...
        db = RegExp("^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$"),
        Z = new U;
    chrome.cast.initialize = function(a, b, c) {
        Z.initialize(a, b, c)
    };
    w("chrome.cast.initialize", chrome.cast.initialize);
    chrome.cast.da = function(a) {
        Z.da(a)
    };
    w("chrome.cast.setPageContext", chrome.cast.da);
    ...
    w("chrome.cast.precache", chrome.cast.Rb);
    chrome.cast.ca = function(a) {
        Z.ca(a)
    };
    w("chrome.cast.requestSessionById", chrome.cast.ca);
    chrome.cast.X = function(a) {
        Z.X(a)
    };
    w("chrome.cast.addReceiverActionListener", chrome.cast.X);
    chrome.cast.aa = function(a) {
        Z.aa(a)
    };
    w("chrome.cast.removeReceiverActionListener", chrome.cast.aa);
    chrome.cast.Qb = function() {};
    w("chrome.cast.logMessage", chrome.cast.Qb);
    chrome.cast.lc = function(a, b) {
        b()
    };
    w("chrome.cast.setCustomReceivers", chrome.cast.lc);
    chrome.cast.mc = function(a, b) {
        b()
    };
    w("chrome.cast.setReceiverDisplayStatus", chrome.cast.mc);
    chrome.cast.unescape = function(a) {
        return a.indexOf("&") != -1 ? "document" in q ? Ba(a) : Ca(a) : a
    };
